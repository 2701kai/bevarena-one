...
const DeveloperPanel = () => {
  ...
  // Add keyboard shortcut (Ctrl+Shift+Numpad8) to toggle panel
  useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.ctrlKey && e.shiftKey && e.code === "Numpad8") {
        e.preventDefault();
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 text-xs text-gray-400">
        <div>Shortcuts:</div>
        <div>
          • Press <span className="font-mono">Ctrl+Shift+Numpad8</span> to
          toggle this panel
        </div>
        <div>
        ...
        <div>
          • Type <span className="font-mono">useContext7("react")</span> in
          console
        </div>
      </div>
    </div>
